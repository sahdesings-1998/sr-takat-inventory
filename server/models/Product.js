...
const productSchema = new Schema(
  {
    ...
    originalCarat: { type: Number, default: 0 },
    soldCarat: { type: Number, default: 0 },
    ...
    location: { type: String, default: "Vault" },
    ...
    history: {
      type: [{ date: { type: Date, default: Date.now }, action: String, user: String, caratSold: Number, remainingCarat: Number, saleId: Schema.Types.ObjectId }],
      default: [],
    },
    grossProfit: {
      type: Number,
