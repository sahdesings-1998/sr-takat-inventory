...
router.get("/profit", requirePermission("reports.view"), reportController.getProfitReport); // Net & Gross profits
router.get("/charity", requirePermission("reports.view"), reportController.getCharityReport); // Charity allocations
